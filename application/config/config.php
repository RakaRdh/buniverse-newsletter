...
|
*/
$config['base_url'] = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://" . (isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : 'localhost:8000') . str_replace(basename($_SERVER['SCRIPT_NAME']), '', $_SERVER['SCRIPT_NAME']);
...
|
*/
$config['encryption_key'] = getenv('JWT_SECRET') ? getenv('JWT_SECRET') : 'b-universe-super-secret-key-12345!';
...
$config['sess_save_path'] = (getenv('VERCEL') || !is_writable(APPPATH . 'cache')) ? sys_get_temp_dir() : APPPATH . 'cache';
